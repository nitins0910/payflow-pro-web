...
exports.handler = async (event) => {
  ...
  if (expectedSignature !== razorpay_signature) {
    return json(400, { error: 'Payment verification failed. If money was deducted, it will be auto-refunded within a few days.' });
  }
  ...
  try {
    ...
    return json(500, { error: 'Payment verified but could not credit your account. Contact support with payment ID: ' + razorpay_payment_id });
  }
};
